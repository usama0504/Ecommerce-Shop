...
<template>
    ...
    <div
        class="fixed top-16 sm:top-20 inset-x-3 sm:inset-x-auto sm:right-6 z-1000 flex flex-col items-center sm:items-end gap-2.5 max-w-md w-auto sm:w-96 pointer-events-none mx-auto sm:mx-0">
